...
function cptui_plugin_menu()
{
	...
	add_submenu_page($parent_slug, __('Thêm/Sửa Post Types', 'custom-post-type-ui'), __('Thêm/Sửa Post Types', 'custom-post-type-ui'), $capability, 'cptui_manage_post_types', 'cptui_manage_post_types');
	add_submenu_page($parent_slug, __('Thêm/Sửa Taxonomies', 'custom-post-type-ui'), __('Thêm/Sửa Taxonomies', 'custom-post-type-ui'), $capability, 'cptui_manage_taxonomies', 'cptui_manage_taxonomies');
...
class SiteOrigin_CSS
{
	...
	function action_admin_menu()
	{
		...
		// add_menu_page(esc_html__('Custom CSS', 'so-css'), esc_html__('Custom CSS', 'so-css'), 'edit_theme_options', 'so_custom_css', array(
		// 	$this,
		// 	'display_admin_page'
		// ));
	...
	function custom_css_revisions_list($theme, $post_id = null, $current_revision = null)
	{
		...
		if (is_array($revisions) && !empty($revisions)) {
			...
			?>
				<li>
					<?php if (!$is_current) : ?>
						<a href="<?php echo esc_url(add_query_arg($query_args, admin_url('themes.php?page=so_custom_css'))) ?>" class="load-css-revision">
						<?php endif; ?>
